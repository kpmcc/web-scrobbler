...
const connectors = [
	{
		label: 'NTS',
		matches: ['*://www.nts.live/shows/*'],
		js: 'connectors/nts.js',
		id: 'nts',
	},
	{
		label: 'YouTube',
	...
	{
		label: 'Jazz24',
		matches: ['*://www.jazz24.org/', '*://v6.player.abacast.net/854'],
	...
	{
		label: 'CodeRadio',
		matches: ['https://coderadio.freecodecamp.org/*'],
	...
	},
	{
		...
		matches: ['*://www.playlist-randomizer.com/*'],
